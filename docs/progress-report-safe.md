...
Generated: 2026-06-26T06:31:35.588Z
Mode: safe

## Summary

- Matrix cases: 15
- Matrix status: stable=2, partial=10, sample-required=1, blocked=2
- Matrix validation errors: 0
- Matrix sample-required cases: 1
- Golden default coverage: 6/8
...
| weibo | mixed-script | partial | 50 | 17 | 2 | 52 | 0 |
| bilibili | protobuf-risk | sample-required | 12 | 10 | 2 | 14 | 0 |
| spotify | header+protobuf-risk | partial | 1 | 2 | 1 | 1 | 0 |
| amap-enhanced | body-json+map-local | partial | 23 | 14 | 2 | 25 | 0 |
| coolapk | script-gap | blocked | 0 | 4 | 0 | 0 | 0 |
| xwebads | script-gap | blocked | 0 | 1 | 0 | 0 | 0 |
...
| id | reasons |
| --- | --- |
| bilibili | sample-required-pattern |
...
| smzdm | yes | partial | 81.8% | 100% | 2 | 2 | 0 |
| bank | yes | partial | 100% | 100% | 0 | 24 | 0 |
